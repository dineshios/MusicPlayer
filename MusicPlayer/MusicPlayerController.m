...
@interface MusicPlayerController () <AVAudioSessionDelegate>
...
+ (MusicPlayerController *)sharedInstance {
    ...
    static MusicPlayerController *instance = nil;
...
void audioRouteChangeListenerCallback (void *inUserData, AudioSessionPropertyID inPropertyID, UInt32 inPropertyValueSize, const void *inPropertyValue) {
    ...
    MusicPlayerController *controller = (__bridge MusicPlayerController *)inUserData;
...
- (void)skipToNextItem {
    if (self.indexOfNowPlayingItem+1 < [self.queue count]) {
        ...
        if (self.repeatMode == MPMusicRepeatModeAll) {
            ...
            NSLog(@"MusicPlayerController: end of queue reached");
            [self stop];
        }
    }
}
